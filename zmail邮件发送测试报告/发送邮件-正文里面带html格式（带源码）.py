...
"""zmail发送邮件：主题+html正文
导包  import zmail
邮件内容：包含：主题（subject）、正文（content_html）-html格式
    ...
    "testResult": [
        {
            ...
            "methodName": "test_1",
            "description": "描述,第一个测试用例",
            "spendTime": "0.001 s",
            "status": "失败",
            "log": [
                "test_1错误\n",
                "Traceback (most recent call last):\n",
                "  File \"D:\\TestTool\\python\\lib\\unittest\\case.py\", line 59, in testPartExecutor\n    yield\n",
                "  File \"D:\\TestTool\\python\\lib\\unittest\\case.py\", line 628, in run\n    testMethod()\n",
                "  File \"D:/TestTool/project_for8/UI自动化/UI自动化第五天/2.用例执行的三种方式/testcase5.py\", line 17, in test_1\n    self.assertEqual(1, 2)\n",
                "  File \"D:\\TestTool\\python\\lib\\unittest\\case.py\", line 852, in assertEqual\n    assertion_func(first, second, msg=msg)\n",
                "  File \"D:\\TestTool\\python\\lib\\unittest\\case.py\", line 845, in _baseAssertEqual\n    raise self.failureException(msg)\n",
                "AssertionError: 1 != 2\n"
            ]
        },
        {
        ...
        },
        {
            ...
            "log": [
                ...
                "  File \"D:\\TestTool\\python\\lib\\unittest\\case.py\", line 59, in testPartExecutor\n    yield\n",
                "  File \"D:\\TestTool\\python\\lib\\unittest\\case.py\", line 628, in run\n    testMethod()\n",
                "  File \"D:/TestTool/project_for8/UI自动化/UI自动化第五天/2.用例执行的三种方式/testcase5.py\", line 27, in test_3\n    self.assertEqual(2, 3)\n",
                "  File \"D:\\TestTool\\python\\lib\\unittest\\case.py\", line 852, in assertEqual\n    assertion_func(first, second, msg=msg)\n",
                "  File \"D:\\TestTool\\python\\lib\\unittest\\case.py\", line 845, in _baseAssertEqual\n    raise self.failureException(msg)\n",
                "AssertionError: 2 != 3\n"
            ]
...
# email = zmail.server(sender[0],sender[1])
